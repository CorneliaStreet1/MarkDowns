...
![objdump](D:\MarkDowns\Pictures Of Markdown\操作系统基础\objdump.jpg)
...
![main](D:\MarkDowns\Pictures Of Markdown\操作系统基础\main.jpg)

### 3.2.3

![3.2.3_1](D:\MarkDowns\Pictures Of Markdown\操作系统基础\3.2.3_1.jpg)

- 以`'.'`开头的行都是指导汇编器和链接器工作的伪指令。忽略即可。



![](D:\MarkDowns\Pictures Of Markdown\操作系统基础\3.3.3_2.jpg)
...
![registers](D:\MarkDowns\Pictures Of Markdown\操作系统基础\registers.jpg)
...
![寻址模式](D:\MarkDowns\Pictures Of Markdown\操作系统基础\寻址模式.jpg)
...
![数据传送源和目的的组合](D:\MarkDowns\Pictures Of Markdown\操作系统基础\数据传送源和目的的组合.jpg)
...
![MOVZ&MOVS](D:\MarkDowns\Pictures Of Markdown\操作系统基础\MOVZ&MOVS.jpg)

### 3.4.3数据传输示例

![数据传输shili](D:\MarkDowns\Pictures Of Markdown\操作系统基础\数据传输shili.jpg)
...
![压入和弹出栈数据](D:\MarkDowns\Pictures Of Markdown\操作系统基础\压入和弹出栈数据.jpg)

- 下图是一个压栈和弹出栈的实例，其中寄存器`%rdx`用来保存弹出栈的数据，`%rax`则用来保存用于压入栈的数据
- 按照惯例栈顶在图的底部，并且栈顶的地址随着压栈是逐渐减小的

![压栈弹出栈实例](D:\MarkDowns\Pictures Of Markdown\操作系统基础\压栈弹出栈实例.jpg)
...
![算术和逻辑操作](D:\MarkDowns\Pictures Of Markdown\操作系统基础\算术和逻辑操作.jpg)
...
![leaq](D:\MarkDowns\Pictures Of Markdown\操作系统基础\leaq.jpg)
...
![128位运算](D:\MarkDowns\Pictures Of Markdown\操作系统基础\128位运算.jpg)
...
![Condition Flag](D:\MarkDowns\Pictures Of Markdown\操作系统基础\Condition Flag.jpg)
...
![TEST_CMP](D:\MarkDowns\Pictures Of Markdown\操作系统基础\TEST_CMP.jpg)
...
![SET](D:\MarkDowns\Pictures Of Markdown\操作系统基础\SET.jpg)
...
![example_CMP](D:\MarkDowns\Pictures Of Markdown\操作系统基础\example_CMP.jpg)
...
![待补全部分](D:\MarkDowns\Pictures Of Markdown\操作系统基础\待补全部分.jpg)
...
![jump_example](D:\MarkDowns\Pictures Of Markdown\操作系统基础\jump_example.jpg)

- Null pointer dereference：空指针解引用，`jump .L1`指令使得这条指令被跳过了。
- 在产生目标代码文件时，汇编器会确定所有带标号指令的地址，并将跳转目标(目的指令的地址)编码为跳转指令的一部分。

![jump instruction set](D:\MarkDowns\Pictures Of Markdown\操作系统基础\jump instruction set.jpg)
...
![PCEncodingexample](D:\MarkDowns\Pictures Of Markdown\操作系统基础\PCEncodingexample.jpg)
...
![链接后的反汇编](D:\MarkDowns\Pictures Of Markdown\操作系统基础\链接后的反汇编.jpg)
...
![条件分支](D:\MarkDowns\Pictures Of Markdown\操作系统基础\条件分支.jpg)

- 懒得写了，看图就好，关于如何利用跳转指令实现条件分支

![跳转指令实现条件分支](D:\MarkDowns\Pictures Of Markdown\操作系统基础\跳转指令实现条件分支.jpg)
...
![条件传送实现条件分支](D:\MarkDowns\Pictures Of Markdown\操作系统基础\条件传送实现条件分支.jpg)
...
![dowhile](D:\MarkDowns\Pictures Of Markdown\操作系统基础\dowhile.jpg)
...
- 关于对汇编代码使用逆向工程：
 ...
 ![逆向工程](D:\MarkDowns\Pictures Of Markdown\操作系统基础\逆向工程.jpg)
